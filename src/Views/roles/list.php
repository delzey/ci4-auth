                ...
                <div class="row">
                    <div class="col">
                        <?php if (has_permissions('roles.create')) { ?>
                            <a href="<?= base_url('ci4auth/roles/create') ?>" class="btn btn-primary"><?= lang('Auth.btn.createRole') ?></a>
                        <?php } ?>
                    </div>
                    <div class="col">
                        <?= bs5_searchform(base_url('ci4auth/roles'), (isset($search)) ? $search : false) ?>
                    </div>
                </div>
            </div>
        </div>
                ...
                <?php if (!empty($roles) && is_array($roles)) :
                    ...
                    <div class="col-lg-12">
                        ...
                        <?php foreach ($roles as $role) : ?>
                            ...
                            <form name="form_<?= $role->id ?>" action="<?= base_url('ci4auth/roles') ?>" method="post">
                                <?= csrf_field() ?>

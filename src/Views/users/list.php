                ...
                <div class="row">
                    <div class="col">
                        <?php if (has_permissions('users.create')) { ?>
                            <a href="<?= base_url('ci4auth/users/create') ?>" class="btn btn-primary"><?= lang('Auth.btn.createUser') ?></a>
                        <?php } ?>
                    </div>
                    <div class="col">
                        <?= bs5_searchform(base_url('ci4auth/users'), (isset($search)) ? $search : false) ?>
                    </div>
                </div>
            </div>
        </div>
                ...
                <?php if (!empty($users) && is_array($users)) :
                    ...
                    <div class="col-lg-12">
                        ...
                        <?php foreach ($users as $user) :
                            ...
                            <form name="form_<?= $user->id ?>" action="<?= base_url('ci4auth/users') ?>" method="post">
                                <?= csrf_field() ?>

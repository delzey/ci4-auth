...
<?= $this->section('main') ?>
    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <?= bs5_cardheader(['icon' => 'bi-person-fill-add', 'title' => lang('Auth.btn.createUser'), 'help' => '#']) ?>

            <div class="card-body">

                <form action="<?= base_url('ci4auth/users/create') ?>" method="post">
                    <?= csrf_field() ?>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a class="btn btn-secondary float-end" href="<?= base_url('ci4auth/users') ?>"><?= lang('Auth.btn.cancel') ?></a>
                        </div>
                    </div>
